<?php
//Custom
Route::get('ipinfo', 'HomeController@ipinfo')->middleware(['auth', 'admin']);
Route::post('ajaxip', 'HomeController@ajaxip')->middleware(['auth', 'admin']);
Route::get('watch', 'HomeController@watch');
